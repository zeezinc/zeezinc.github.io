...
const App: React.FC = () => {
  ...
  return (
    <div className={`relative min-h-screen font-sans transition-colors duration-500 ${bgClass} ${selectionClass}`}>
      ...
      <nav className={`fixed top-0 w-full z-40 backdrop-blur-md border-b transition-colors duration-500 ${navBg}`}>
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={toggleTheme}
              className={`flex items-center gap-2 text-sm font-bold uppercase tracking-wider px-5 py-2 rounded-full border-2 transition-all hover:scale-105 active:scale-95 ${theme === 'neon'
                ...
                {isResumeOpen && (
                  ...
                  >
                    <div className="flex flex-col p-1">
                      <a
                        href="https://app.rezi.ai/s/zeezinc-ai"
                        target="_blank"
          ...
          {activeProfile.certificates.map((cert) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="mb-4">
                  <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold tracking-wider uppercase mb-2 ${theme === 'neon' ? 'bg-neon-purple/20 text-neon-purple' : 'bg-mech-indigo/10 text-mech-indigo'
                    }`}>
      ...
      {/* Footer */}
      <footer className={`py-12 text-center text-sm relative z-10 backdrop-blur-sm border-t ${theme === 'neon'
